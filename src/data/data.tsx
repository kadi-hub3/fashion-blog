...
export default [
  ...
  },
  {
    ...
    category: "beauty",
    desc:
      "If only I got a penny for every time I got asked for my best packing tips. Ok I understand that perhaps its not the best time ever to talk about packing because where would we go? But now I probably have your attention and we can discuss my best packing tips.",
    fullDesc:
      "If only I got a penny for every time I got asked for my best packing tips. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut id sem eu felis rutrum mattis. Aliquam vitae diam justo. Cras id commodo tellus. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nulla vehicula quam vitae est laoreet, id volutpat libero pellentesque. Fusce id nulla ultrices, dictum nunc sit amet, lacinia nibh. Quisque egestas ante egestas urna condimentum fringilla. In vitae arcu nec orci pulvinar bibendum non et dui. Nunc neque magna, euismod vel libero sed, elementum lobortis neque. Phasellus dictum eu eros vitae auctor. Sed facilisis porttitor dolor id convallis. Proin tempus turpis massa, sed malesuada arcu auctor ut. Aenean iaculis nisi eget nunc consequat, id egestas massa finibus. Etiam nibh magna, euismod non risus eget, lacinia tincidunt quam.",
  },
  {
    id: 3,
    src: img3,
    ...
    category: "looks",
    desc:
      "Ladies and Gentlemen Trench Kelly 25 in Bleu Brume is here and I will talk about my first",
    fullDesc:
  ...
  },
  {
    ...
    category: "beauty",
    desc:
      "In this post you will find the latest beauty trends to experiment with this Spring! From Freckles to Bold Eye Shadow, its all in here",
    fullDesc:
      "Ladies and Gentlemen Trench Kelly 25 in for my best packing tips. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut id sem eu felis rutrum mattis. Aliquam vitae diam justo. Cras id commodo tellus. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nulla vehicula quam vitae est laoreet, id volutpat libero pellentesque. Fusce id nulla ultrices, dictum nunc sit amet, lacinia nibh. Quisque egestas ante egestas urna condimentum fringilla. In vitae arcu nec orci pulvinar bibendum non et dui. Nunc neque magna, euismod vel libero sed, elementum lobortis neque. Phasellus dictum eu eros vitae auctor. Sed facilisis porttitor dolor id convallis. Proin tempus turpis massa, sed malesuada arcu auctor ut. Aenean iaculis nisi eget nunc consequat, id egestas massa finibus. Etiam nibh magna, euismod non risus eget, lacinia tincidunt quam.",
  },
  {
  ...
  },
  {
    ...
    category: "looks",
    desc:
      "Discover all there is to know about Dior’s latest jacket release – The Point.",
    fullDesc:
      "Ladies and Gentlemen Trench Kelly 25 in for my best packing tips. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut id sem eu felis rutrum mattis. Aliquam vitae diam justo. Cras id commodo tellus. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nulla vehicula quam vitae est laoreet, id volutpat libero pellentesque. Fusce id nulla ultrices, dictum nunc sit amet, lacinia nibh. Quisque egestas ante egestas urna condimentum fringilla. In vitae arcu nec orci pulvinar bibendum non et dui. Nunc neque magna, euismod vel libero sed, elementum lobortis neque. Phasellus dictum eu eros vitae auctor. Sed facilisis porttitor dolor id convallis. Proin tempus turpis massa, sed malesuada arcu auctor ut. Aenean iaculis nisi eget nunc consequat, id egestas massa finibus. Etiam nibh magna, euismod non risus eget, lacinia tincidunt quam.",
  },
  {
  ...
  },
  {
    ...
    category: "looks",
    desc:
      "In this post you will discover a few of my favourite pieces from Valentino’s Spring/Summer RTW collection.",
    fullDesc:
      "Ladies and Gentlemen Trench Kelly 25 in for my best packing tips. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut id sem eu felis rutrum mattis. Aliquam vitae diam justo. Cras id commodo tellus. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nulla vehicula quam vitae est laoreet, id volutpat libero pellentesque. Fusce id nulla ultrices, dictum nunc sit amet, lacinia nibh. Quisque egestas ante egestas urna condimentum fringilla. In vitae arcu nec orci pulvinar bibendum non et dui. Nunc neque magna, euismod vel libero sed, elementum lobortis neque. Phasellus dictum eu eros vitae auctor. Sed facilisis porttitor dolor id convallis. Proin tempus turpis massa, sed malesuada arcu auctor ut. Aenean iaculis nisi eget nunc consequat, id egestas massa finibus. Etiam nibh magna, euismod non risus eget, lacinia tincidunt quam.",
  },
  {
  ...
  },
  {
    id: 10,
    src: img9,
    title: "trend guide: why you need a suit in 2020",
    category: "looks",
    desc:
      "In this post you will discover a few of my favourite pieces from Valentino’s Spring/Summer RTW collection.",
    fullDesc:
  ...
  },
  {
    id: 12,
    src: img12,
    title: "best black friday 2021 favourites",
    category: "looks",
    desc:
      "In this post you will discover a few of my favourite pieces from Valentino’s Spring/Summer RTW collection.",
    fullDesc:
  ...
  },
  {
    id: 13,
    src: img13,
    title: "winter beauty must haves",
    category: "beauty",
    desc:
      "In this post you will find the latest beauty trends to experiment with this Spring! From Freckles to Bold Eye Shadow, its all in here",
    fullDesc:
  ...
  },
  {
    id: 16,
    src: img16,
    title: "minimalist outfit with charles & keith",
    category: "looks",
    desc:
      "In this post you will find the latest beauty trends to experiment with this Spring! From Freckles to Bold Eye Shadow, its all in here",
    fullDesc:
